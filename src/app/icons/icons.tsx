export const cv = (
    <svg fill="none" viewBox="0 0 24 24" height="2em" width="2em">
      <path fill="currentColor" d="M7 18h10v-2H7v2zM17 14H7v-2h10v2zM7 10h4V8H7v2z" />
      <path
        fill="currentColor"
        fillRule="evenodd"
  ...
  export const linkedinIcon = (
    <svg viewBox="0 0 900 1000" fill="currentColor" height="1.8em" width="1.8em">
  ...
  export const githubIcon = (
    <svg fill="currentColor" viewBox="0 0 16 16" height="1.8em" width="1.8em">
